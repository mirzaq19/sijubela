    ...
    <div class="container my-5 bg-white rounded">
        <form class="px-2" action="/register" method="POST">
            ...
            <div class="divider d-flex align-items-center pt-4 mb-5">
                <h1 class="text-center fw-bold mx-3 mb-0 text-blue">Register</h1>
            </div>
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input type="text" name="buyer_username" id="username"
                ...
                <div class="col">
                    ...
                    <input type="text" name="buyer_full_name" id="fullname"
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input type="email" name="buyer_email" id="email"
            ...
            <div class="form-outline mb-3">
                ...
                <div class="input-group">
                    <input type="password" name="buyer_password" id="password"
            ...
            <div class="text-center justify-content-center d-flex flex-column text-lg-start mt-4 pt-2 pd-register">
                ...
                <p class="small text-center fw-bold mt-2 pt-1 pb-4">Have an account? <a
                        href="{{ route('pembeli-login') }}" class="text-blue text-decoration-none">Login</a></p>
            </div>
