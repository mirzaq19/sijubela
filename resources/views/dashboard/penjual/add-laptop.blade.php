    ...
    <div class="container my-5 bg-white rounded px-3">
        ...
        @if ($bank == null)
            <div class="alert alert-warning">
                <strong>Warning!</strong> You don't have any bank account. Please
                <a href="/dashboard/setting" class="text-decoration-none">
        ...
        <form action="/dashboard/add-laptop" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 pb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('sell_laptop_brand') is-invalid @enderror" name="sell_laptop_brand"
                        id="sell_laptop_brand" required {{ $bank == null ? 'disabled' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('sell_laptop_type') is-invalid @enderror" name="sell_laptop_type"
                        id="sell_laptop_type" required {{ $bank == null ? 'disabled' : '' }}>
            ...
            <button type="submit" class="btn btn-success mb-3 {{ $bank == null ? 'disabled' : '' }}">Add Laptop</button>
